...
sample = '../Billionaire_samples.csv'
# sample = '../trans_samples.csv'
...
history = model.fit(padded_sequence, sentiment_label[0], validation_split=0.2,
                    epochs=15, batch_size=15, callbacks=my_callbacks)

# model.save('models/' + sample[:-12])
...
# model.save('models/' + sample[:-12])
print(export_model.predict("I love billionaires"))
